  ...
  return (
    ...
    <div className="introduction grid justify-items-center m-5  md:flex">
        <div className="intro-content text-2xl m-10  space-y-6 md:px-20">
            ...
            <h1>I am fluent in classics like <i className='text-purple-500  font-bold'>Html5, CCS3, JAVASCRIPT, NODE, REACT,Express, Mongodb, Cookies, JWT</i> </h1>
   ...
   <div  id='contact' className="findMe  text-center space-y-5 mb-20">
