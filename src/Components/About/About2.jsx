  ...
  return (
    <>
      ...
      <div className=' w-80 md:w-[700px] sm:w-[300px] mx-auto mb-10 grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2  md:mx-auto gap-5 text-center '>
        <div className= 'border-2 border-purple-500 text-2xl py-5 rounded-md transition ease-in-out delay-150 hover:translate-1 hover:scale-110 item-centre justify-center  item-2xl'>HTML</div>
